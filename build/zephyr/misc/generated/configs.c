...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HTCW_BITS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HTCW_BITS_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HTCW_DATA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HTCW_DATA_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HTCW_IO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IO_NO_FS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HTCW_IO_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HTCW_ML, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HTCW_ML_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HTCW_GFX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HTCW_GFX_MODULE, 1);
